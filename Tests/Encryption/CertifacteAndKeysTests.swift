...
final class CertifacteAndKeysTests: XCTestCase {
  ...
  func testPublicKeyFromValidRSAPEM() {
    let publicKey = SecCertificateUtilities.publicKey(fromPem: rsaPemString)
    XCTAssertNotNil(publicKey, "Public key should not be nil for a valid certificate")
  }
  
  func testPublicKeyFromValidECPEM() {
    
    let publicKey = SecCertificateUtilities.publicKey(fromPem: ecPemString)
    XCTAssertNotNil(publicKey, "Public key should not be nil for a valid certificate")
  }
  ...
  func testPublicKeyFromInvalidPEM() {
    ...
    let publicKey = SecCertificateUtilities.publicKey(fromPem: invalidPemString)
  ...
  func testCertificateChainValidation() {
    ...
    _ = SecCertificateUtilities.validateCertificateChain(
